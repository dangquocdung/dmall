                                    ...
                                    <div class="tab-pane fade active show" id="custom-v-pills-shipping" role="tabpanel"
                                        ...
                                        <div>
                                                    ...
                                                    <div class="border p-3 rounded">
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" id="homeDeliveryRadio"
                                                                   name="shippingOptions" class="custom-control-input" @if(!$carts[0]->product->shop->available_for_delivery) disabled @endif>
                                                            <label class="custom-control-label font-16 font-weight-bold"
                                                                   for="homeDeliveryRadio">{{__('user.home_delivery')}} @if(!$carts[0]->product->shop->available_for_delivery)<small class="text-danger"> ({{__('user.currently_this_shop_is_not_available_for_delivery')}})</small> @endif</label>
                                                        </div>
                                            ...
                                            <div id="address-section" class="d-none">
                                                <h4 class="header-title mt-4 ">{{__('user.saved_address')}}</h4>
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="col-md-6 mt-3">
                                                            <div class="border p-3 rounded mb-3 mb-md-0">
                                                                <div
                                                                    ...
                                                                    <input type="radio" id="address-radio-{{$loop->index}}"
                                                                           name="addressRadio"
                                                                           class="custom-control-input" @if($loop->index==0) checked @endif @if(!\App\Helpers\DistanceUtil::isValidForDelivery($carts[0]->product->shop,$userAddress)) disabled @endif>
                                                                    <label
                                                                ...
                                                                <p class="mb-2 mt-2"><span class="font-weight-semibold mr-2">{{__('user.address')}}:</span>
                                                    ...
                                                    <div class="col-md-6 mt-3">
                                                        ...
                                                        <div class="border p-3 rounded mb-3 mb-md-0" style="border-style: dashed !important;">

                                                            <h3 class="text-center"> + {{__('user.add_new_address')}}</h3>
                                        ...
                                        <div>
                                            ...
                                            <div class="border p-3 mb-3 mt-3 rounded">
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="razorpayPaymentRadio" name="billingOptions"
                                                           class="custom-control-input">
                                                    <label class="custom-control-label font-16 font-weight-bold"
                                                           for="razorpayPaymentRadio">{{__('user.pay_with')}} Razorpay</label>
                                                </div>
                                        ...
                                        <div class="text-sm-right mt-2 mt-sm-0">
                                            <button id="placeOrderBtn"
                                               class="btn btn-success">
                                                <i class="mdi mdi-shopping-outline mr-1"></i> {{__('user.place_order')}} </button>
                                        </div>
                                    </div> <!-- end col -->
                                </div> <!-- end row -->
                            </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered table-nowrap mb-0">
                                            ...
                                            <tr class="text-right">
                                                ...
                                                <td class="text-right">
                                                    {{\App\Helpers\AppSetting::$currencySign}}<span id="order-text"></span>
                                                </td>
                                            </tr>
                                            <tr class="text-right">
                                                <td colspan="1" class="font-weight-bolder">
                                                ...
                                                <td class="text-right">
                                                    - {{\App\Helpers\AppSetting::$currencySign}}<span id="coupon-discount-text"></span>
                                                </td>
                                            </tr>
                                            <tr class="text-right">
                                                <td colspan="1" class="font-weight-bolder">
                                                ...
                                                <td class="text-right">
                                                    {{\App\Helpers\AppSetting::$currencySign}}<span id="tax-text"></span>
                                                </td>
                                            </tr>
                                            <tr class="text-right">
                                                <td colspan="1" class="font-weight-bolder">
                                                ...
                                                <td class="text-right">
                                                    {{\App\Helpers\AppSetting::$currencySign}}<span id="delivery-fee-text"></span>
                                                </td>
                                            </tr>
                                            <tr class="text-right">
                                                ...
                                                <td class="text-right text-dark font-weight-bold" >
                                                    {{\App\Helpers\AppSetting::$currencySign}}<span id="total-text"></span>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
...
@section('script')
    ...
    <script>
        ...
        placeOrderBtn.addEventListener('click',function (){
            ...
            form.appendChild(createInputElementHidden('payment_type',CODPaymentRadio.checked?1:2));
